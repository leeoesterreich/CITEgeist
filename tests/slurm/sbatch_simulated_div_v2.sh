#!/bin/bash
#SBATCH --job-name=sim_div_v2
#SBATCH --output=slurm_log/sim_div_v2_%j.out
#SBATCH --error=slurm_log/sim_div_v2_%j.err
#SBATCH --ntasks=1
...
# ============================================================================
# Simulated benchmark: diversity penalty (lambda_reg_gex=0.01)
# Uses isolated checkpoint dir to avoid cache contamination
# ============================================================================
...
python tests/test_citegeist_simulated.py \
    ...
    --output_folder test_results/diversity_penalty_v2 \
...
python tests/test_citegeist_simulated.py \
    ...
    --max_y_change 0.05 \
    --input_folder replicates/high_seg \
    --output_folder test_results/baseline_v2 \
    --sample_prefix Wu_rep \
    --lambda-laplacian 0.0 \
    --lambda-reg-gex 0.0
