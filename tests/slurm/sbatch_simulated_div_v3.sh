#!/bin/bash
#SBATCH --job-name=sim_div_v3
#SBATCH --output=slurm_log/sim_div_v3_%j.out
#SBATCH --error=slurm_log/sim_div_v3_%j.err
#SBATCH --ntasks=1
...
# ============================================================================
# Simulated benchmark v3: fixed lambda_reg_gex wiring in citegeist_model.py
...
python tests/test_citegeist_simulated.py \
    ...
    --output_folder test_results/diversity_penalty_v3 \
...
python tests/test_citegeist_simulated.py \
    ...
    --max_y_change 0.05 \
    --input_folder replicates/high_seg \
    --output_folder test_results/baseline_v3 \
    --sample_prefix Wu_rep \
    --lambda-laplacian 0.0 \
    --lambda-reg-gex 0.0
