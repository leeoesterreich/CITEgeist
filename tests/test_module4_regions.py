...
class TestCompareProgramsByRegion:
    ...
    def test_returns_dataframe_with_expected_columns(self):
        ...
        from CITEgeist.model.programs.anchored_program_discovery import compare_programs_by_region
...
class TestExtractProgramContextGenes:
    ...
    def test_returns_list_of_tuples(self):
        ...
        from CITEgeist.model.programs.anchored_program_discovery import extract_program_context_genes
