#! /usr/bin/bash
#SBATCH --job-name=Seurat_hs_deconv
#SBATCH --output=./logs/Seurat_deconv_hs_%a.out
#SBATCH --error=./logs/Seurat_deconv_hs_%a.err
#SBATCH --time=0:30:00
#SBATCH --ntasks=1
...
INPUT_DIR="/bgfs/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/replicates/high_seg/h5ad_objects"
OUTPUT_H5SEURAT_DIR="/bgfs/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/replicates/high_seg/h5seurat"
OUTPUT_DIR="/bgfs/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/Seurat/high_seg/"
...
Rscript --vanilla Seurat_hs.R "$FILE" "$OUTPUT_DIR" "$BASENAME"
