...
# Use NB Module 3 outputs (9 cell types)
...
def load_module3_outputs(sample_name: str) -> tuple:
    ...
    # Load cell type proportions (NB results in per-sample subdirectory)
    prop_file = MODULE3_OUTPUT / sample_name / f"{sample_name}_cell_prop_nb_results.csv"
