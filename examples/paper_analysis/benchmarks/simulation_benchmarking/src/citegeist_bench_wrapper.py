...
def main(predictions_dir, ground_truth_gex_dir, output_dir, folder_pattern, normalize="range"):
    ...
    try:
        ground_truth_samples = [
            f
            for f in os.listdir(ground_truth_gex_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "predictions_dir",
        type=str,
        help="Path to the directory containing predicted CSV files (with Wu_rep_X folders).",
    )
    parser.add_argument(
        "ground_truth_gex_dir",
        type=str,
        help="Path to the directory containing ground truth GEX files (with sample_X folders).",
    )
