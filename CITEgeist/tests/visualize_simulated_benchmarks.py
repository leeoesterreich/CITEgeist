        ...
        for file in files:
            if file.endswith("_metrics_combined.csv") and "Wu_rep_" in file:
                ...
                try:
                    ...
                    metrics_data["improvements"]["mae"][param_key].append(((pass1_mae - pass2_mae) / pass1_mae) * 100)
            ...
            for idx_l, l in enumerate(lambdas):
                for idx_r, r in enumerate(radii):
                    if (r, l) in means:
                        ...
                        annotation_texts[idx_l, idx_r] = format_annotation(means[(r, l)], stds[(r, l)])
                    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-dir", type=str, default="figures", help="Directory to save the output figures (default: figures)"
    )
