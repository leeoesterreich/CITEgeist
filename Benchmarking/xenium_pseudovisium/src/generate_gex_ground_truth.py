...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate gene expression ground truth for Xenium benchmarking"
    )
    parser.add_argument(
        "--use-rna-types",
        action="store_true",
    ...
    if args.output_dir:
        ...
        OUTPUT_BASE = REPO_ROOT / "Benchmarking" / "xenium_pseudovisium" / "data_rna_gt"
    else:
        OUTPUT_BASE = REPO_ROOT / "Benchmarking" / "xenium_pseudovisium" / "data"
