#!/bin/bash
#SBATCH --job-name=tangram_high_seg        # Job name
...
cd /ihome/acillo/bts76/Simulations/scCube_12k/Tangram/high_seg
if [ $? -ne 0 ]; then
...
python Tangram.py \
    --spatial_path "/ix1/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/replicates/high_seg/h5ad_objects/${REPLICATE_NAME}" \
    --output_dir "/ihome/acillo/bts76/Simulations/scCube_12k/Tangram/high_seg/tangram_map_${SLURM_ARRAY_TASK_ID}" \
