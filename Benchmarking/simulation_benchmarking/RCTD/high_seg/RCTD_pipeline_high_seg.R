...
st_data_path <- paste0("/bgfs/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/replicates/high_seg/ST_sim/", replicate_name, "_data.csv")
st_meta_path <- paste0("/bgfs/alee/LO_LAB/Personal/Brent_Schlegel/Projects/Wu_Visium/Simulations/scCube_12k/replicates/high_seg/ST_sim/", replicate_name, "_meta.csv")
