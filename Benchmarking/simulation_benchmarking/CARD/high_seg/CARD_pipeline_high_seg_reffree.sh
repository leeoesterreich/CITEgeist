#!/bin/bash
#SBATCH --job-name=CARD_hs_rf
#SBATCH --output=./logs/CARD_hs_reffree_%a.out
#SBATCH --error=./logs/CARD_hs_reffree_%a.err
...
# Run CARD deconvolution on high_seg simulation (REFERENCE-FREE mode)
