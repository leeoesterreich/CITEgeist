#!/bin/bash
#SBATCH --job-name=seurat_xenium
#SBATCH --output=/ix1/alee/LO_LAB/Personal/Alexander_Chang/alc376/CITEgeist/Benchmarking/xenium_benchmarking/Seurat/slurm/slurm_log/xenium_%A_%a.out
#SBATCH --error=/ix1/alee/LO_LAB/Personal/Alexander_Chang/alc376/CITEgeist/Benchmarking/xenium_benchmarking/Seurat/slurm/slurm_log/xenium_%A_%a.err
#SBATCH --array=0-4
...
# Note: Seurat only outputs proportions, not GEX layers
...
R_ENV="/ix1/alee/LO_LAB/Personal/Alexander_Chang/alc376/envs/r_deconv_env"

echo "=============================================="
echo "Seurat Xenium Benchmark - Region ${REGION_ID}"
echo "=============================================="
...
# Step 2: Run Seurat (using R)
echo ""
echo "=============================================="
echo "Step 2: Running Seurat TransferData"
echo "=============================================="

# Activate R environment (using full path as specified)
echo "Activating r_deconv_env from ${R_ENV}..."
