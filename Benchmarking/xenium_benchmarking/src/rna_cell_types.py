...
XENIUM_KIDNEY_RNA_CLUSTER_MAP = {
    1: "T cells",           # CD3E=378, CD8A=210 - T lymphocytes
    2: "Macrophages",       # CD68=430, HLA-DR=317 - Myeloid cells
    3: "Mixed_Immune",      # CD3E=142, HLA-DR=142 - Mixed lymphoid/myeloid
    4: "Epithelial",        # PanCK=39, low immune markers
    5: "Fibroblasts",       # alphaSMA=108 - Stromal cells
    6: "Mixed_Stromal",     # alphaSMA=35, mixed markers
    7: "Endothelial",       # CD31=168 - Vascular endothelium
    8: "B cells",           # CD20=293 - B lymphocytes
    9: "Plasma_Endo",       # CD31=139, CD138 elevated - Mixed
    10: "Endothelial_2",    # CD31=53 - Secondary endothelial cluster
}

# Simplified mapping for benchmark comparison
# Groups related cell types for cleaner analysis
SIMPLIFIED_CELLTYPE_MAP = {
    "T cells": "T cells",
    "B cells": "B cells",
    "Macrophages": "Macrophages",
    "Mixed_Immune": "Macrophages",  # Assign to Macrophages for simplicity
    "Fibroblasts": "Fibroblasts",
    "Mixed_Stromal": "Fibroblasts",  # Assign to Fibroblasts
    "Epithelial": "Epithelial",
    "Endothelial": "Endothelial",
    "Endothelial_2": "Endothelial",
    "Plasma_Endo": "Endothelial",  # Primarily endothelial by CD31
}
