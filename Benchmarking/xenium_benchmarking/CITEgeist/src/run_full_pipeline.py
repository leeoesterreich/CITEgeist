...
# Path: Benchmarking/xenium_benchmarking/CITEgeist/src/run_full_pipeline.py -> 5 levels to repo root
...
# Add xenium_pseudovisium and evaluation to path
PSEUDOVISIUM_SRC = Path(__file__).parent.parent.parent.parent.parent / "Benchmarking" / "xenium_pseudovisium" / "src"
EVALUATION_SRC = Path(__file__).parent.parent.parent / "evaluation" / "src"
sys.path.insert(0, str(PSEUDOVISIUM_SRC))
